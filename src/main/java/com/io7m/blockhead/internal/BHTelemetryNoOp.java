...
public final class BHTelemetryNoOp
  implements BHTelemetryServiceType
{
  ...
  public static BHTelemetryNoOp noop()
  {
    final var noop = OpenTelemetry.noop();
    return new BHTelemetryNoOp(
      noop.getTracer("noop"),
      noop.getMeter("noop"),
