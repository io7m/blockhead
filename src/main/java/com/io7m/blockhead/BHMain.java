...
package com.io7m.blockhead;

import com.io7m.blockhead.internal.BHRun;
...
public final class BHMain implements Runnable
{
  private static final Logger LOG =
    LoggerFactory.getLogger(BHMain.class);
    ...
    final String[] inArgs)
  {
    ...
    final var metadata =
      new QApplicationMetadata(
        ...
        BHVersion.MAIN_BUILD,
        "The blockhead command-line application.",
        Optional.of(URI.create("https://www.io7m.com/software/blockhead/"))
      );

    final var builder = QApplication.builder(metadata);
    builder.allowAtSyntax(true);
    builder.addCommand(new BHRun());
  ...
  public static int mainExitless(
    final String[] args)
  {
    final BHMain cm = new BHMain(args);
    cm.run();
    return cm.exitCode();
  }
