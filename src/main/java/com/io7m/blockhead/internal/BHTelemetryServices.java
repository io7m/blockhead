...
public final class BHTelemetryServices
  implements BHTelemetryServiceFactoryType
{
  private static final Logger LOG =
    LoggerFactory.getLogger(BHTelemetryServices.class);

  /**
   * An OpenTelemetry service factory.
   */

  public BHTelemetryServices()
  {
  ...
  private static SdkLoggerProvider createLoggerProvider(
    ...
    final BHTelemetryConfiguration.Logs logs)
  {
  ...
  private static SdkMeterProvider createMeterProvider(
    final Resource resource,
    final BHTelemetryConfiguration.Metrics metrics)
  {
  ...
  private static SdkTracerProvider createTracerProvider(
    final Resource resource,
    final BHTelemetryConfiguration.Traces traces)
  {
  ...
  @Override
  public BHTelemetryServiceType create(
    final BHTelemetryConfiguration telemetryConfiguration)
  {
      ...
      Resource.getDefault()
        .merge(Resource.create(
          Attributes.builder()
            ...
            .put(SERVICE_VERSION, BHVersion.MAIN_VERSION)
            .build()
        ));
    ...
    final var logger =
      openTelemetry.getLogsBridge()
        .loggerBuilder("com.io7m.blockhead")
        .build();

    return new BHTelemetryService(
      tracer,
      meter,
      logger,
